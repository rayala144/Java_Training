...
class ThreadedServer extends Thread {
	...
	Socket incoming;
	int counter;
	String dirn = "C:/Users/rayala.akhil/FTP SERVER DIRECTORY";
	...
	public void run() {
		try {
			...
			if (c.equals("#")) {
				...
				System.out.println("Request to download file " + filenm + "recieved from "
						+ incoming.getInetAddress().getHostName() + "...");
				try {
				...
				try {
					boolean done = true;
					System.out.println("Request to upload file " + fn + "recieved from "
							+ incoming.getInetAddress().getHostName() + "...");
