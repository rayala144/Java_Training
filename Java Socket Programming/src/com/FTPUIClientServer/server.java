...
class threadedServer extends Thread {
	...
	public void waitForPackets() {
		while (true) {
			try {
				...
				System.out.println("Incoming command: " + command.trim() + " from: " + clientInetAddr + " from Port: "
						+ clientPort);
	...
	public void sendFile(String fileName, File fl) throws Exception {
		...
		System.out.println("Size:" + fsize + " bytes, Number of Packets: " + totalPackets + " Size of packet: "
				+ MAXSIZE + " bytes");
